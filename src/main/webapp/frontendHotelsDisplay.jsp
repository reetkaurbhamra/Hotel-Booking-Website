<%-- 
    Document   : frontendHotelsDisplay
    Created on : Mar 30, 2023, 1:32:14 AM
    Author     : student
--%>
...
<%@page import= "com.mycompany.search.persistence.Hotel_CRUD"%>
...
<html>
    ...
    <form action="Login">
        ...
        <BR>
        <% 
            ArrayList<Hotel> hotelsAvailable = (ArrayList)request.getAttribute("availableHotels");
        %>
        <BR>
        ...
        <tr>
            <table cellpadding = "10" bgcolor = "white" style="width: 70%">
                ...
                <tr width="100">
                    ...
                    <td>Rooms Available: <%=hotel.getRating()%> </td>
                </tr>
                <tr width="100">
